...
@Component({
  ...
  imports: [SelectButtonModule, ReactiveFormsModule, CommonModule, PrimeErrorComponent],
...
export class PrimeSelectButtonComponent<T> extends CustomControlValueAccessorDirective<T> {
